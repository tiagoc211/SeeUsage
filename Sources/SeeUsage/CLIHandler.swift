...
public enum CLIHandler {
    ...
    static func bold(_ text: String) -> String { color("1", text) }
    static func dim(_ text: String) -> String { color("90", text) }
    static func green(_ text: String) -> String { color("38;2;0;229;153", text) } // #00e599
    static func amber(_ text: String) -> String { color("38;2;250;158;46", text) } // #fa9e2e
    static func red(_ text: String) -> String { color("38;2;245;71;82", text) }    // #f54752
    static func cyan(_ text: String) -> String { color("38;2;56;189;248", text) }  // #38bdf8
    static func purple(_ text: String) -> String { color("38;2;168;119;250", text)}// #a877fa

    static func quotaColor(for pct: Double?) -> (String) -> String {
    ...
    private static func setTheme(id: String) {
        ...
        guard let theme = ThemeRegistry.themeIfKnown(for: cleanID) else {
            print("\n" + red("✗") + " Unknown theme '\(id)'. Use 'seeusage themes' to list available themes.\n")
            return
        }
    ...
    static func printTable(store: UsageStore, settings: SettingsStore) {
